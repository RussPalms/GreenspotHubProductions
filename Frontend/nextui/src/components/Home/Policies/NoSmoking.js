...
const NoSmoking = ({ fill, className }) => {
	return (
		<>
			<NoSmokingPolicy
				className={className}
			...
			>
				<path
					fill={fill}
					d="M32,0C14.355,0,0,14.355,0,32s14.355,32,32,32s32-14.355,32-32S49.645,0,32,0z M32,62C15.458,62,2,48.542,2,32
	S15.458,2,32,2s30,13.458,30,30S48.542,62,32,62z"
				/>
				<path
					fill={fill}
					d="M32,6c-5.678,0-11.072,1.798-15.601,5.201c-0.232,0.174-0.376,0.44-0.397,0.729s0.085,0.573,0.291,0.777l17,17l8,8l10,10
	...
	C56,36.853,54.577,41.482,51.873,45.459z"
				...
				<path
					fill={fill}
					d="M32.707,36.293l-8-8l-12-12c-0.205-0.205-0.495-0.308-0.777-0.291c-0.289,0.021-0.555,0.165-0.729,0.397
	...
	C41.482,54.577,36.853,56,32,56z"
				/>
				<rect fill={fill} x="49" y="28" width="2" height="10" />
				<path
					fill={fill}
					d="M45,20c-1.103,0-2-0.897-2-2v-1c0-2.206-1.794-4-4-4h-7v2h7c1.103,0,2,0.897,2,2v1c0,2.206,1.794,4,4,4h2
	c1.103,0,2,0.897,2,2v2h2v-2c0-2.206-1.794-4-4-4H45z"
				/>
				<path
					fill={fill}
					d="M39,22c0-2.206-1.794-4-4-4h-5v2h5c1.103,0,2,0.897,2,2c0,2.206,1.794,4,4,4h6v-2h-6C39.897,24,39,23.103,39,22z"
				/>
				<rect fill={fill} x="28" y="13" width="2" height="2" />
				<rect fill={fill} x="24" y="13" width="2" height="2" />
			</NoSmokingPolicy>
		</>
	);
};
...
export const NoSmokingPolicy = styled.svg`
	height: 100px;
	width: 100px;
